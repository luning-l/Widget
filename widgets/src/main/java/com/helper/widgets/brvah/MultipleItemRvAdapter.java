...
import com.helper.widgets.brvah.provider.BaseItemProvider;
import com.helper.widgets.brvah.util.MultiTypeDelegate;
import com.helper.widgets.brvah.util.ProviderDelegate;
...
public abstract class MultipleItemRvAdapter<T, V extends BaseViewHolder> extends BaseQuickAdapter<T, V> {
    ...
    @Override
    protected void convert(@NonNull V helper, int pos, T item) {

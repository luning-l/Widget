...
import com.helper.widgets.brvah.callback.ItemDragAndSwipeCallback;
import com.helper.widgets.brvah.listener.IDraggableListener;
import com.helper.widgets.brvah.listener.OnItemDragListener;
import com.helper.widgets.brvah.listener.OnItemSwipeListener;

import java.util.Collections;

import static com.helper.widgets.brvah.BaseQuickAdapter.EMPTY_VIEW;
import static com.helper.widgets.brvah.BaseQuickAdapter.FOOTER_VIEW;
import static com.helper.widgets.brvah.BaseQuickAdapter.HEADER_VIEW;
import static com.helper.widgets.brvah.BaseQuickAdapter.LOADING_VIEW;

/**
 * 把拖拽、滑动删除的功能封装到一个类里，更加适合扩展
 */

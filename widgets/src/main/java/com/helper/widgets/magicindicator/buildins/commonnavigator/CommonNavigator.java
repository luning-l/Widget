package com.helper.widgets.magicindicator.buildins.commonnavigator;
...
import com.helper.widgets.magicindicator.NavigatorHelper;
import com.helper.widgets.magicindicator.ScrollState;
import com.helper.widgets.magicindicator.abs.IPagerNavigator;
import com.helper.widgets.magicindicator.buildins.commonnavigator.abs.CommonNavigatorAdapter;
import com.helper.widgets.magicindicator.buildins.commonnavigator.abs.IMeasurablePagerTitleView;
...
import com.helper.widgets.magicindicator.buildins.commonnavigator.model.PositionData;
...
public class CommonNavigator extends FrameLayout implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    private void init() {
        ...
        View root;
        if (mAdjustMode) {
            root = LayoutInflater.from(getContext()).inflate(R.layout._magicindicator_pager_navigator_layout_no_scroll, this);
        } else {
            root = LayoutInflater.from(getContext()).inflate(R.layout._magicindicator_pager_navigator_layout, this);
        }

package com.helper.widgets.banner.view;
...
public class BannerLoopViewPager extends RecyclerView {
    ...
    public BannerLoopViewPager(Context context, AttributeSet attrs, int defStyle) {
